  ...
  const menu = [
    {
      ...
      children: [
          ...
          children: [
            {
              id: 'history',
              title: 'Історія',
              link: 'https://hyundai-ck.com.ua/istoriya-kompanii-hyundai',
            },
            {
              id: 'mission',
              title: 'Місія та цінності',
              link: 'https://hyundai-ck.com.ua/misiya-ta-cinnosti-kompanii-hyundai',
            },
            {
              id: 'philosophy',
              title: 'Філософія бренду',
              link: 'https://hyundai-ck.com.ua/regular-and-special-information',
            },
            {
              id: 'ukraine',
              ...
              children: [
                {
                  ...
                  link: 'https://hyundai-ck.com.ua/hyundai-in-ukraine',
                },
                {
                  id: 'ua-info',
        ...
        },
        {
          id: 'news',
          title: 'Новини',
          link: 'https://hyundai-ck.com.ua/news_ck',
        },
        {
          id: 'innovation',
          title: 'Інновації',
          children: [
            {
              ...
              link: 'https://hyundai-ck.com.ua/smart-tech',
            },
            {
              id: 'eco',
              title: 'ЕКО',
              link: 'https://hyundai-ck.com.ua/eco-technology',
            },
            {
              id: 'performance',
              title: 'Продуктивність',
              link: 'https://hyundai-ck.com.ua/performance',
            },
            {
              id: 'transmission',
              title: 'Трансмісія',
              link: 'https://hyundai-ck.com.ua/powertrain',
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              link: 'https://hyundai-ck.com.ua/wrc-2019-winners',
            },
            {
              id: 'wrc-main',
              title: 'Hyundai у WRC',
              link: 'https://hyundai-ck.com.ua/wrc',
            },
          ],
        },
      ],
  ...
  return (
    <List sx={styles.topMenuLayout}>
      ...
      <ListItemButton
        ...
        component="a"
        href="https://hyundai-ck.com.ua/contacts-ck"
        target="_blank"
      >
        <ListItemText primary="Контакти" />
      </ListItemButton>
      <ListItemButton sx={styles.topMenuItem} component="a" href="https://sklad.hyundai-ck.com.ua/">
      ...
      <ListItemButton
        sx={styles.topMenuItem}
        component="a"
        href="https://hyundai-ck.com.ua/zapys-servis-ck"
        target="_blank"
      >
      ...
      <ListItemButton
        sx={styles.topMenuItem}
        component="a"
        href="https://hyundai-ck.com.ua/test-drive-ck"
        target="_blank"
      >
      ...
      <ListItemButton
        sx={styles.topMenuItem}
        component="a"
        href="https://hyundai-ck.com.ua/video-review-ck"
        target="_blank"
      >
