  ...
  const menu = [
    {
      ...
      children: [
          ...
          children: [
            {
              id: 'history',
              title: 'Історія',
              link: 'https://hyundai-if.com.ua/istoriya-kompanii-hyundai',
            },
            {
              id: 'mission',
              title: 'Місія та цінності',
              link: 'https://hyundai-if.com.ua/misiya-ta-cinnosti-kompanii-hyundai',
            },
            {
              id: 'philosophy',
              title: 'Філософія бренду',
              link: 'https://hyundai-if.com.ua/regular-and-special-information',
            },
            {
              id: 'ukraine',
              ...
              children: [
                {
                  ...
                  link: 'https://hyundai-if.com.ua/hyundai-in-ukraine',
                },
                {
                  id: 'ua-info',
        ...
        },
        {
          id: 'news',
          title: 'Новини',
          link: 'https://hyundai-if.com.ua/news_if',
        },
        {
          id: 'innovation',
          title: 'Інновації',
          children: [
            {
              ...
              link: 'https://hyundai-if.com.ua/smart-tech',
            },
            {
              id: 'eco',
              title: 'ЕКО',
              link: 'https://hyundai-if.com.ua/eco-technology',
            },
            {
              id: 'performance',
              title: 'Продуктивність',
              link: 'https://hyundai-if.com.ua/performance',
            },
            {
              id: 'transmission',
              title: 'Трансмісія',
              link: 'https://hyundai-if.com.ua/powertrain',
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              link: 'https://hyundai-if.com.ua/wrc-2019-winners',
            },
            {
              id: 'wrc-main',
              title: 'Hyundai у WRC',
              link: 'https://hyundai-if.com.ua/wrc',
            },
          ],
        },
      ],
  ...
  return (
    <List sx={styles.topMenuLayout}>
      ...
      <ListItemButton
        ...
        component="a"
        href="https://hyundai-if.com.ua/contacts-if"
        target="_blank"
      >
        <ListItemText primary="Контакти" />
      </ListItemButton>

      <ListItemButton sx={styles.topMenuItem} component="a" href="https://sklad.hyundai-if.com.ua/">
      ...
      <ListItemButton
        sx={styles.topMenuItem}
        component="a"
        href="https://hyundai-if.com.ua/zapys-servis-if"
        target="_blank"
      >
      ...
      <ListItemButton
        sx={styles.topMenuItem}
        component="a"
        href="https://hyundai-if.com.ua/test-drive-if"
        target="_blank"
      >
      ...
      <ListItemButton
        sx={styles.topMenuItem}
        component="a"
        href="https://hyundai-if.com.ua/video-review-if"
        target="_blank"
      >
