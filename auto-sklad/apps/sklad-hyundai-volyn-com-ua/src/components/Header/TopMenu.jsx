  ...
  const menu = [
    {
      ...
      children: [
          ...
          children: [
            {
              id: 'history',
              title: 'Історія',
              link: 'https://hyundai-volyn.com.ua/istoriya-kompanii-hyundai',
            },
            {
              id: 'mission',
              title: 'Місія та цінності',
              link: 'https://hyundai-volyn.com.ua/misiya-ta-cinnosti-kompanii-hyundai',
            },
            {
              id: 'philosophy',
              title: 'Філософія бренду',
              link: 'https://hyundai-volyn.com.ua/regular-and-special-information',
            },
            {
              id: 'ukraine',
              ...
              children: [
                {
                  ...
                  link: 'https://hyundai-volyn.com.ua/hyundai-in-ukraine',
                },
                {
                  id: 'ua-info',
        ...
        },
        {
          id: 'news',
          title: 'Новини',
          link: 'https://hyundai-volyn.com.ua/news_lutsk',
        },
        {
          id: 'innovation',
          title: 'Інновації',
          children: [
            {
              ...
              link: 'https://hyundai-volyn.com.ua/smart-tech',
            },
            {
              id: 'eco',
              title: 'ЕКО',
              link: 'https://hyundai-volyn.com.ua/eco-technology',
            },
            {
              id: 'performance',
              title: 'Продуктивність',
              link: 'https://hyundai-volyn.com.ua/performance',
            },
            {
              id: 'transmission',
              title: 'Трансмісія',
              link: 'https://hyundai-volyn.com.ua/powertrain',
            },
          ],
        },
        {
          ...
          children: [
            {
              ...
              link: 'https://hyundai-volyn.com.ua/wrc-2019-winners',
            },
            {
              id: 'wrc-main',
              title: 'Hyundai у WRC',
              link: 'https://hyundai-volyn.com.ua/wrc',
            },
          ],
        },
      ],
  ...
  return (
    <List sx={styles.topMenuLayout}>
      ...
      <ListItemButton
        ...
        component="a"
        href="https://hyundai-volyn.com.ua/contacts-lutsk"
        target="_blank"
      >
        <ListItemText primary="Контакти" />
      </ListItemButton>

      <ListItemButton sx={styles.topMenuItem} component="a" href="https://sklad.hyundai-volyn.com.ua/">
      ...
      <ListItemButton
        sx={styles.topMenuItem}
        component="a"
        href="https://hyundai-volyn.com.ua/zapys-servis-lutsk"
        target="_blank"
      >
      ...
      <ListItemButton
        sx={styles.topMenuItem}
        component="a"
        href="https://hyundai-volyn.com.ua/test-drive-lutsk"
        target="_blank"
      >
      ...
      <ListItemButton
        sx={styles.topMenuItem}
        component="a"
        href="https://hyundai-volyn.com.ua/video-review-lutsk"
        target="_blank"
      >
